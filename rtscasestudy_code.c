...
/**
  ******************************************************************************  
  * @file           : main.c
  * @brief          : Main program body for Case Study - Sensor and Actuator Integration  
  ******************************************************************************  
  */
...
void StartLEDBlinkTask(void *argument)
{
  for (;;)
  {
    ...
    // Transmit data via UART (could be other protocols like I2C/SPI)
    printf("LED blinked.\n");
...
/**
  * @brief  Distance Calculation Task
  * @retval None
  */
void StartDistanceCalcTask(void *argument)
{
  for (;;)
  {
    ...
    // Transmit distance value via UART
